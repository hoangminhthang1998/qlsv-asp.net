...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td></td>
            <td style="text-align: center;">Mã điều kiện</td>
        ...
        <tr>
            ...
            <td>
            <div style="float:left;">
                <asp:TextBox ID="tbx_mdk" runat="server" CssClass="w3-input w3-small  w3-border" Width="100px" Height="36px" OnTextChanged="tbx_del_TextChanged" ></asp:TextBox>
            </div></td>
            <td>
            <div style="float:left;">
