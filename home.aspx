    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div id="popup_tinhocmo" style="display:none; margin-top: 10px;">
                ...
                <asp:GridView ID="GridView1" runat="server" class="table table-bordered dataTable" AutoGenerateColumns="False" DataKeyNames="masv" DataSourceID="SqlDataSource1">
            ...
            <div id="popup_thtd" style="display:none; margin-top: 10px;">  
                <asp:GridView ID="GridView2" runat="server" class="table table-bordered dataTable" AutoGenerateColumns="False" DataKeyNames="masv" DataSourceID="SqlDataSource2">
                    <Columns>
                        <asp:BoundField DataField="masv" HeaderText="Mã SV" ReadOnly="True" SortExpression="masv" />
                        <asp:BoundField DataField="tensv" HeaderText="Tên SV" SortExpression="tensv" />
                        <asp:BoundField DataField="Column1" HeaderText="Giới tính" ReadOnly="True" SortExpression="Column1" />
            ...
            <div id="popup_thkt" style=" display: none; margin-top: 10px;">
                <asp:GridView ID="GridView3" runat="server" class="table table-bordered dataTable" AutoGenerateColumns="False" DataKeyNames="masv" DataSourceID="SqlDataSource3">
                    <Columns>
                        <asp:BoundField DataField="masv" HeaderText="Mã SV" ReadOnly="True" SortExpression="masv" />
                        <asp:BoundField DataField="tensv" HeaderText="Tên SV" SortExpression="tensv" />
                        <asp:BoundField DataField="Column1" HeaderText="Giới tính" ReadOnly="True" SortExpression="Column1" />
            ...
            <div id="popup_thdc" style="display: none; margin-top: 10px;">
                <asp:GridView ID="GridView4" runat="server"  class="table table-bordered dataTable" AutoGenerateColumns="False" DataKeyNames="masv" DataSourceID="SqlDataSource4">
                    <Columns>
                        <asp:BoundField DataField="masv" HeaderText="Mã SV" ReadOnly="True" SortExpression="masv" />
                        <asp:BoundField DataField="tensv" HeaderText="Tên SV" SortExpression="tensv" />
                        <asp:BoundField DataField="Column1" HeaderText="Giới tính" ReadOnly="True" SortExpression="Column1" />
            ...
            <div id="popup_mmt" style=" display:none; margin-top: 10px;">
                <asp:GridView ID="GridView5" runat="server" class="table table-bordered dataTable" AutoGenerateColumns="False" DataKeyNames="masv" DataSourceID="SqlDataSource5">
                    <Columns>
                        <asp:BoundField DataField="masv" HeaderText="Mã SV" ReadOnly="True" SortExpression="masv" />
                        <asp:BoundField DataField="tensv" HeaderText="Tên SV" SortExpression="tensv" />
                        <asp:BoundField DataField="Column1" HeaderText="Giới tính" ReadOnly="True" SortExpression="Column1" />
            ...
            <div id="popup_cnpm" style="display: none; margin-top: 10px;">
                <asp:GridView ID="GridView6" runat="server" class="table table-bordered dataTable" AutoGenerateColumns="False" DataKeyNames="masv" DataSourceID="SqlDataSource6">
                    <Columns>
                        <asp:BoundField DataField="masv" HeaderText="Mã SV" ReadOnly="True" SortExpression="masv" />
                        <asp:BoundField DataField="tensv" HeaderText="Tên SV" SortExpression="tensv" />
                        <asp:BoundField DataField="Column1" HeaderText="Giới tính" ReadOnly="True" SortExpression="Column1" />
            ...
            <div id="popup_khmt" style="display: none; margin-top: 10px;">
                <asp:GridView ID="GridView7" runat="server" class="table table-bordered dataTable" AutoGenerateColumns="False" DataKeyNames="masv" DataSourceID="SqlDataSource7">
                    <Columns>
                        <asp:BoundField DataField="masv" HeaderText="Mã SV" ReadOnly="True" SortExpression="masv" />
                        <asp:BoundField DataField="tensv" HeaderText="Tên SV" SortExpression="tensv" />
                        <asp:BoundField DataField="Column1" HeaderText="Giới tính" ReadOnly="True" SortExpression="Column1" />
