...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="w3-padding-4" >
         ...
         <asp:Label ID="lbl_thongbao" runat="server" CssClass="error" Text="xxx" Visible="False"></asp:Label>
         <div> 
        ...
        <div style="float:left;">
            <asp:Button ID="btt_edit" runat="server" Text="Sửa"  CssClass="w3-btn w3-blue" OnClick="btt_edit_Click" Height="36px" Width="80px" PostBackUrl="~/sinhvienedit.aspx"/>
        </div>
        <div style="float:left;">
